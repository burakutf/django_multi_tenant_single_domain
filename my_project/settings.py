...
MIDDLEWARE = [
    ...
    'my_project.apps.tenant.middleware.CustomTenantMainMiddleware',
    'django_tenants.middleware.TenantSubfolderMiddleware',
    'my_project.apps.tenant.middleware.TenantMediaMiddleware',
...
STATIC_ROOT = '/app/my_project/static/'

DEFAULT_FILE_STORAGE = 'django_tenants.files.storage.TenantFileSystemStorage'
MULTITENANT_RELATIVE_MEDIA_ROOT = ''

MEDIA_ROOT = '/app/my_project/media/'
MEDIA_URL = 'media/'
